...
from info import ADMINS, LOG_CHANNEL, SUPPORT_CHAT, MELCOW_NEW_USERS, MELCOW_IMG
...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            buttons = [[
                InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url=f'https://t.me/sillunu_oru_movies')
            ]]
        ...
        if settings["welcome"]:
            for u in message.new_chat_members:
                ...
                temp.MELCOW['welcome'] = await message.reply_photo(
                                                 photo=(MELCOW_IMG),
                                                 caption=f'<b>ʜᴇʟʟᴏ {u.mention}🧚\nᴡᴇʟᴄᴏᴍᴇ ᴛᴏ {message.chat.title}🦋\n\nYᴏᴜ Cᴀɴ Rᴇǫᴜᴇsᴛ Aɴʏ Mᴏᴠɪᴇs, Wᴇʙ-Sᴇʀɪᴇs, Aɴɪᴍᴇ, K-Dʀᴀᴍᴀ, Aɴɪᴍᴀᴛɪᴏɴ Hᴇʀᴇ....\n\n⚡ɢʀᴏᴜᴩ ʀᴜʟᴇꜱ⚡\n\n‣ɢᴜʟᴜ ɢᴜʟᴜ 2022\n‣ꜱɪᴛᴀ ʀᴀᴍᴀᴍ 2022</b>',
                                                 reply_markup=InlineKeyboardMarkup(
                                                                         [[
                                                                           InlineKeyboardButton('🚀ᴜᴩᴅᴀᴛᴇꜱ🚀', url='https://t.me/sillunu_oru_movies'),
                                                                           InlineKeyboardButton('📡ᴄʜᴀɴɴᴇʟ📡', url='https://t.me/sillunu_oru_movies')
                                                                        ]]
                                                 ),
